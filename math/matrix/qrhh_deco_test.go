...
func ExampleQRHH_orthogonal() {
	...
	// Output:
	// [(-0.7071067811865475+0i) (-0.7071067811865476+0i)]
	// [(-0.7071067811865476+0i) (0.7071067811865475+0i)]
	//
	// [(-1+0i) (1.1102230246251565e-16+0i)]
	// [(-1.1102230246251565e-16+0i) (-1+0i)]
	//
	// true
	// true
}

func ExampleQRHH_rankdeficient() {
